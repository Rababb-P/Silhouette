export function Footer() {
  return (
    <footer className="w-full bg-black border-t border-gray-800 py-12 mt-16">
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-8">
          {/* Brand Section */}
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-white">Silhouette</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
              AI-powered fashion recommendations tailored to your unique style. 
              Discover your perfect look with cutting-edge technology.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-3">
              ...
              <a 
                href="mailto:contact@silhouette.com" 
                className="text-gray-400 hover:text-white transition-colors text-sm"
              >
                Contact
              </a>
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Follow us on social media for style tips and updates.
            </p>
